...
{
    public class ClickableView : ewfregtrbfvfedw, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        [SerializeField]
        ...
        [SerializeField] private ewfregtrbfvfedw viewContainer;
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            if (HasSound)
            {
                qewergtrhtyujmjk.trbgvfsc.tynrtbervsc();
            }
            
            IsDown = true;
            OnDownEvent?.Invoke();
            pointerTween?.Kill(true);
            pointerTween = pointerDownAnimator.gnhgrwfe(viewContainer);
        }
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            OnUpEvent?.Invoke();
            pointerTween?.Kill(true);
            pointerTween = pointerUpAnimator.gnhgrwfe(viewContainer);
        }
